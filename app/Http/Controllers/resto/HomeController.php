...
class HomeController extends Controller
{
    ...
    public function index(Request $request){
        ...
        $order_batal_terakhir = Jual::whereRaw("status_jual='BATAL' AND waktu_batal>=? AND
        waktu_batal<?", [Carbon::today()->firstOfMonth(), Carbon::today()
        ->firstOfMonth()->addMonth(1)])->count();
        ...
        'jual', 'rating_50', 'rating_semua','order_minggu_terakhir','order_batal_terakhir','order_bulan_ini'));
